...
import xinhocbong.api.SignUpControllerApi;
...
public class SignUpController extends Component {
    ...
    public void signUp() {
        ...
        String sql = "INSERT INTO TAIKHOAN(usename, password) VALUES(?,?);\n";
...
//                focus đến vị trí chưa nhập
            ...
            if (!signUpUserName.getText().equals("") && !signUpPassWord.getText().equals("") && !signUpComfirmPassWord.getText().equals("") && password.equals(confirm)) {
                ...
                SignUpControllerApi.getDataAllScholarshipUsers( signUpUserName.getText(),signUpPassWord.getText());
//                pst.execute();
            }
