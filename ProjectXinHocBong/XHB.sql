...
INSERT INTO TAIKHOAN(usename, password) VALUES('La', '123');
...
FROM  SINHVIEN
 ...
 where THONGTINHOCBONG.NGAYNHAN <='2018-03-29' and  THONGTINHOCBONG.SOTIEN is not null and TOCHUC.TENTOCHUC is not null;
